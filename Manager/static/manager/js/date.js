...
function ShowCalendar(InputBox)
{
    ...
    DivContent+="<td style='border-bottom:1px solid #0066FF; background-color:#C7D8FA; font-weight:bold;  font-size:12px; padding-top:2px; color:#4477FF; cursor:pointer' align='center' title='¹Ø±Õ' onClick='javascript:HiddenCalendar()'>¹Ø±Õ</td>";
    DivContent+="</tr>";
